...
export type OutputActionInterface =
  | OnChangeOutputInterface
  | OnChangeClearOutputInterface
  | OnChangeIsMinusInterface
  | OnChangeCalculateInterface
  | OnChangeIsOperatorClickInterface;
